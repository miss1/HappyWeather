...
import com.yangll.bishe.happyweather.adapter.ManagerCityHolder2;
import com.yangll.bishe.happyweather.adapter.OnItemRemoveListener;

public class ItemRemoveRecycleView extends RecyclerView {
    ...
    public ItemRemoveRecycleView(Context context) {
        this(context, null);
    }

    public ItemRemoveRecycleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemRemoveRecycleView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    ManagerCityHolder2 viewHolder = (ManagerCityHolder2) getChildViewHolder(view);
